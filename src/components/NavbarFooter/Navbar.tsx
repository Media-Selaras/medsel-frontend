        ...
        {({ open }) => (
          <>
            ...
            <Disclosure.Panel className="lg:hidden absolute top-16 left-0 w-full bg-white shadow-md">
              <div className="px-5 pt-1 pb-3 space-y-4 text-center items-center flex space-x-6">
  <Link href="/" className="px-6 py-0 text-gray-900 hover:bg-gray-200 rounded-md flex items-center">Beranda</Link>
